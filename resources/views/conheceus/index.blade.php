            ...
            <div class="col-md-12">
                <div class="data-white">
                    <table id="table" class="display datatable">
                        ...
                        <tbody>
                            @forelse($conheceus as $conheceu)
                                <tr>
                                    <td>{{$conheceu->id}}</td>
                                    <td>{{$conheceu->nome}}</td>
                                    <td>{{$conheceu->descricao}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('conheceus.edit', $conheceu->id)}}">
                                                <span style="padding: 5px" class="btn btn-success raised icon"><i class="zmdi zmdi-edit"></i> </span>
                                            </a>
                                            <a href="{{route('conheceus.show', $conheceu->id)}}">
