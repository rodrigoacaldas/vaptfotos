    ...
    <div class="content-box">
        <div class="head head-with-btns clearfix">
            ...
            <div class="functions-btns pull-right">
                <a href="{{route('meiocontatos.create')}}">
            ...
            <div class="col-md-12">
                <div class="data-white">
                    <table id="table" class="display datatable">
                        ...
                        <tbody>
                            @forelse($meiocontatos as $meiocontato)
                                <tr>
                                    <td>{{$meiocontato->id}}</td>
                                    <td>{{$meiocontato->nome}}</td>
                                    <td>{{$meiocontato->descricao}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('meiocontatos.edit', $meiocontato->id)}}">
                                                <span style="padding: 5px" class="btn btn-success raised icon"><i class="zmdi zmdi-edit"></i> </span>
                                            </a>
                                            <a href="{{route('meiocontatos.show', $meiocontato->id)}}">
