            ...
            <div class="col-md-12">
                <div class="data-white">
                    <table id="table" class="display datatable">
                        ...
                        <tbody>
                            @forelse($tipofotos as $tipofoto)
                                <tr>
                                    <td>{{$tipofoto->id}}</td>
                                    <td>{{$tipofoto->nome}}</td>
                                    <td>{{$tipofoto->descricao}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('tipofotos.edit', $tipofoto->id)}}">
                                                <span style="padding: 5px" class="btn btn-success raised icon"><i class="zmdi zmdi-edit"></i> </span>
                                            </a>
                                            <a href="{{route('tipofotos.show', $tipofoto->id)}}">
