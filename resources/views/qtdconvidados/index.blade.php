    ...
    <div class="content-box">
        <div class="head head-with-btns clearfix">
            ...
            <div class="functions-btns pull-right">
                <a href="{{route('qtdconvidados.create')}}">
            ...
            <div class="col-md-12">
                <div class="data-white">
                    <table id="table" class="display datatable">
                        ...
                        <tbody>
                            @forelse($qtdconvidados as $qtdconvidado)
                                <tr>
                                    <td>{{$qtdconvidado->id}}</td>
                                    <td>{{$qtdconvidado->nome}}</td>
                                    <td>{{$qtdconvidado->descricao}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('qtdconvidados.edit', $qtdconvidado->id)}}">
                                                <span style="padding: 5px" class="btn btn-success raised icon"><i class="zmdi zmdi-edit"></i> </span>
                                            </a>
                                            <a href="{{route('qtdconvidados.show', $qtdconvidado->id)}}">
