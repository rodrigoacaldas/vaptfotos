    ...
    <div class="content-box">
        <div class="head head-with-btns clearfix">
            ...
            <div class="functions-btns pull-right">
                <a href="{{route('tipocancelamentos.create')}}">
            ...
            <div class="col-md-12">
                <div class="data-white">
                    <table id="table" class="display datatable">
                        ...
                        <tbody>
                            @forelse($tipocancelamentos as $tipocancelamento)
                                <tr>
                                    <td>{{$tipocancelamento->id}}</td>
                                    <td>{{$tipocancelamento->nome}}</td>
                                    <td>{{$tipocancelamento->descricao}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('tipocancelamentos.edit', $tipocancelamento->id)}}">
                                                <span style="padding: 5px" class="btn btn-success raised icon"><i class="zmdi zmdi-edit"></i> </span>
                                            </a>
                                            <a href="{{route('tipocancelamentos.show', $tipocancelamento->id)}}">
